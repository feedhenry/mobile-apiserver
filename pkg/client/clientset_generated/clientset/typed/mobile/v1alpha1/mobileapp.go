...
import (
	v1alpha1 "github.com/feedhenry/mobile-apiserver/pkg/apis/mobile/v1alpha1"
	scheme "github.com/feedhenry/mobile-apiserver/pkg/client/clientset_generated/clientset/scheme"
...
type MobileAppInterface interface {
	Create(*v1alpha1.MobileApp) (*v1alpha1.MobileApp, error)
	Update(*v1alpha1.MobileApp) (*v1alpha1.MobileApp, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.MobileApp, error)
	List(opts v1.ListOptions) (*v1alpha1.MobileAppList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MobileApp, err error)
	MobileAppExpansion
}
...
func newMobileApps(c *MobileV1alpha1Client, namespace string) *mobileApps {
	return &mobileApps{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *mobileApps) Create(mobileApp *v1alpha1.MobileApp) (result *v1alpha1.MobileApp, err error) {
	result = &v1alpha1.MobileApp{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mobileapps").
		Body(mobileApp).
...
func (c *mobileApps) Update(mobileApp *v1alpha1.MobileApp) (result *v1alpha1.MobileApp, err error) {
	result = &v1alpha1.MobileApp{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mobileapps").
...
func (c *mobileApps) Get(name string, options v1.GetOptions) (result *v1alpha1.MobileApp, err error) {
	result = &v1alpha1.MobileApp{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mobileapps").
...
func (c *mobileApps) List(opts v1.ListOptions) (result *v1alpha1.MobileAppList, err error) {
	result = &v1alpha1.MobileAppList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mobileapps").
...
func (c *mobileApps) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MobileApp, err error) {
	result = &v1alpha1.MobileApp{}

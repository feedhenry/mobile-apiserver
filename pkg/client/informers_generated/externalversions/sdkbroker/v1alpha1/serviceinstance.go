...
import (
	mobile_v1alpha1 "github.com/feedhenry/mobile-apiserver/pkg/apis/mobile/v1alpha1"
	...
	v1alpha1 "github.com/feedhenry/mobile-apiserver/pkg/client/listers_generated/sdkbroker/v1alpha1"
	...
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.SdkbrokerV1alpha1().ServiceInstances(v1.NamespaceAll).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.SdkbrokerV1alpha1().ServiceInstances(v1.NamespaceAll).Watch(options)
			},
		},
		&mobile_v1alpha1.ServiceInstance{},
		resyncPeriod,
...
func (f *serviceInstanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mobile_v1alpha1.ServiceInstance{}, newServiceInstanceInformer)
}

...
import (
	...
	cmdserver "github.com/feedhenry/mobile-apiserver/cmd/server/start"
	apiserver "github.com/feedhenry/mobile-apiserver/pkg/apiserver"
...
func startServer(config *apiserver.Config) (chan struct{}, clientset.Interface, dynamic.ClientPool, error) {
	...
	bytes, _ := brokerClient.Discovery().RESTClient().Get().AbsPath("/apis/mobile.k8s.io/v1alpha1").DoRaw()
